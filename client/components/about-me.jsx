      ...
      <Container className="container-md">
        <Row>
          ...
          <Col md="8">
            ...
            <p>While enrolled in the program, I learned languages like JavaScript (ES5 + ES6), React.js, jQuery, Node.js, PHP, HTML, and CSS. I also became intimately familiar with tools like Git/Github, Postman, npm, and Webpack. Lastly, I participated in team-based hackathons, as well as solo projects, to build full-stack web applications. Experiencing all of this has solidified that I have made the right decision to pursue web development, and has helped feed my curiosity.</p>
